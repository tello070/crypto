                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {formatCurrency(parseFloat(amount))} @ ${selectedCoinData?.price.toLocaleString()}
                        </div>
                      </div>
                    </div>
                  </CardContent>
              ...
              <Card className="bg-muted/30 border-primary/20">
                <CardContent className="p-4 space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                      <div className="font-bold">{getCoinAmount().toFixed(8)} {selectedCoinData.symbol}</div>
                      <div className="text-xs text-muted-foreground">{formatCurrency(parseFloat(amount))}</div>
                    </div>
                  </div>
